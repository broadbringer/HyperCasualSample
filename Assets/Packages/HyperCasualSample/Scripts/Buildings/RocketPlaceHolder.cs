...
{
    public class RocketPlaceHolder : MonoBehaviour
    {
        ...
        private Vector3 ColumnSpacing = new Vector3(0.52f, 0, 0);
        private Vector3 RowSpacing = new Vector3(0, 0, 0.64f);
        private float YDelta = 1.07f;
